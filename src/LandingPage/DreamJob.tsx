...
const DreamJob=()=>
{
    return (
        ...
        <div className="flex flex-col w-[45%] gap-3">
             ...
             [&_input]:!text-mine-shaft-100" label="Job title"  variant="unstyled" placeholder="Software Engineer"/>
             <TextInput className="bg-mine-shaft-900 rounded-lg p-1 px-2 text-mine-shaft-100
              [&_input]:!text-mine-shaft-100" label="Job type" variant="unstyled" placeholder="Fulltime"/>
             <div className="flex items-center justify-center h-full w-20 bg-bright-sun-400 text-mine-shaft-100
             rounded-lg p-2 hover:bg-bright-sun-500 cursor-pointer">
        ...
        <div className="w-[55%] flex items-center justify-center ">
         <div className="w-[30rem] relative">
            ...
            <div className="absolute -right-10 w-fit top-[50%] border-bright-sun-400
          ...
          <Avatar>+9K</Avatar>
            ...
            <div className="absolute -left-11 w-fit top-[28%] border-bright-sun-400
             border rounded-lg p-2 backdrop-blur-md gap-3 flex flex-col">
