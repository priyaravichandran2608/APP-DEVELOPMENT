...
const Working=()=>
{
    ...
    <div className="text-4xl text-center font-semibold mb-10 text-mine-shaft-100">How it 
        <span className="text-bright-sun-400"> Works</span></div>
        <div className="text-lg mb-10 mx-auto text-mine-shaft-300 text-center w-1/2 ">Effortlessly navigate through 
