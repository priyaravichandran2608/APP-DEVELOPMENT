...
const JobCategory=()=>{
    return (
     ...
     <div className="text-4xl text-center font-semibold mb-10 text-mine-shaft-100">Browse 
         <span className="text-bright-sun-400"> Job</span> Category </div>
         <div className="text-lg mb-10 mx-auto text-mine-shaft-300 text-center w-1/2 ">Explore diverse job oppurtunities 
          ...
          previousControlIcon={<IconArrowLeft className="h-8 w-8" />}>
       {
        jobCategory.map((category,index)=><Carousel.Slide>
         ...
         rounded-xl hover:cursor-pointer hover:shadow-[0_0_5px_2px_black] my-5
          transition duration-300 ease-in-out !shadow-bright-sun-300">
            ...
            <div className="text-mine-shaft-100 text-xl font-bold">
            {category.name}
            </div>
